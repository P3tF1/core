...
export function PetSelector({ pets, onSelectPet }: PetSelectorProps) {
  ...
  if (pets.length === 0) {
    return (
      <div className="text-center p-4 bg-red-100 rounded-lg">
        <p className="text-red-600 font-semibold">You don't have any pets to play with!</p>
        <p className="text-red-500">Visit the Pet Market to get your first pet.</p>
      </div>
    )
  }
  ...
  return (
    <div className="bg-white p-4 rounded-lg shadow-md">
      <h3 className="text-lg font-semibold mb-4 text-center">Choose Your Pet</h3>
