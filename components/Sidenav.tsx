...
import { PawPrint, ShoppingBag, Gamepad2, ShoppingCart, Coins } from "lucide-react"
...
export function Sidenav({ activeSection, setActiveSection, setShowBuyTokens }: SidenavProps) {
  const navItems = [
